...
import com.selva.example_employee_app.callBack.AlertDialogCallBack
import com.selva.example_employee_app.util.ViewUtils
import com.selva.example_employee_app.viewmodel.RemoveListViewModel
...
class RemoveListFragment : DaggerFragment() {
    ...
    private fun initView(root: View) {
        ...
        root.findViewById<FloatingActionButton>(R.id.fab_logout).setOnClickListener {
